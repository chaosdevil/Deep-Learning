...
test_y_encoded = ct.transform(test_y)
test_y_encoded = test_y_encoded[:, 1:]
test_y_scaled = sc.transform(test_y_encoded)

test_y_pred = classifier.predict(test_y_scaled)
